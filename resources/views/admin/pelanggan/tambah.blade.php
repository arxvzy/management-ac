...
@section('content')
    <div>
        ...
        <form action="{{ route('admin.pelanggan.simpan') }}" method="POST"
            ...
            <label class="block text-sm">
                ...
                <input
                    ...
                    placeholder="Nama" name="nama" type="text" value="{{ old('nama') }}" />
                @error('nama')
            ...
            <label class="mt-4 block text-sm">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    placeholder="No. Telp" name="no_hp" type="tel" value="{{ old('no_hp') }}" />
                @error('no_hp')
                    <span class="text-red-400">{{ $message }}</span>
                @enderror
            </label>
            <label class="mt-4 block text-sm">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    placeholder="Alamat" name="alamat" type="text" value="{{ old('alamat') }}" />
                @error('password')
                    <span class="text-red-400">{{ $message }}</span>
                @enderror
            </label>
